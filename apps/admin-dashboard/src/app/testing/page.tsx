  ...
  return (
    <div className="max-w-[1000px] mx-auto px-4 py-8">
      ...
      <div className="mt-6 grid gap-5 md:grid-cols-1 max-w-[560px]">
        ...
        {/* 🚧 the Why-Not gate-proof card was folded INTO Menu 3 at the
            boss's order (2026-09-07: "the menu should be inside Menu 3 —
            please do not make separate"); the 🚧 button on Menu 3 opens it */}
