    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="border border-gray-800 rounded-lg p-4 bg-gray-900/50">
          <h2 className="text-sm font-semibold text-gray-300 mb-3">Latest Daily Report</h2>
          <p className="text-xs text-gray-400 leading-relaxed">{stats.latestDaily}...</p>
        </div>
        <div className="border border-gray-800 rounded-lg p-4 bg-gray-900/50">
          <h2 className="text-sm font-semibold text-gray-300 mb-3">Latest Weekly Report</h2>
          <p className="text-xs text-gray-400 leading-relaxed">{stats.latestWeekly}...</p>
        </div>
      </div>
      ...
      <div className="border border-gray-800 rounded-lg bg-gray-900/50">
        <div className="px-4 py-3 border-b border-gray-800">
          <h2 className="text-sm font-semibold text-gray-300">Recent Task Runs</h2>
        </div>
