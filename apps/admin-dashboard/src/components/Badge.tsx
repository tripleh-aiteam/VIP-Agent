const styles: Record<string, string> = {
  ...
  received: "text-[var(--badge-blue-text)] bg-[var(--badge-blue-bg)]",
  delivered: "text-[var(--badge-success-text)] bg-[var(--badge-success-bg)]",
  processed: "text-[var(--badge-success-text)] bg-[var(--badge-success-bg)]",
  processing: "text-[var(--badge-blue-text)] bg-[var(--badge-blue-bg)]",
  manual_review: "text-[var(--badge-warning-text)] bg-[var(--badge-warning-bg)]",
