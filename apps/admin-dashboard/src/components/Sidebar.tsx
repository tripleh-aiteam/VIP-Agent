...
const nav = [
  // Chatbot — customer-facing message inbox (KakaoTalk + phone). Pinned at TOP
  // because it's the primary boss-facing workspace. The floating <Assistant>
  // overlay in the bottom-right is a separate, helper-style UI.
