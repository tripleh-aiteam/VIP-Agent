...
def build_breaking_report(db, trace_id: str, focus: str | None = None,
    ...
    try:
        ...
        sysmsg = (
            ...
            "   - the 2-4 biggest events + overall market read; each event with a severity 1-10.\n"
            "## 2. 이벤트별 영향 분석 (Event-by-event)\n"
            "   - for EACH major event: 무슨 일인지(사실), 출처 국가/매체, 그리고 영향받는 종목 표:\n"
