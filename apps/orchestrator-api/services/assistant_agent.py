...
def _build_system_prompt(
    ...
    return (
        ...
        "        – PREFERRED (our own two methods): call two_method_view(ticker=X). It "
        "returns BOTH of our decision methods + the live price. In the answer, present "
        "BOTH explicitly: 'Method 1 — Machine-Learning Algorithms: <BUY/HOLD/SELL>, best "
        "algorithm <name>, expected 5-day move <%>, backtest accuracy <%>' AND 'Method 2 "
        "— Analysis (수급/호가/박스권): <매수/관망/매도>, buy/sell levels <numbers>, reasons "
        "<수급·박스권>'. Then give YOUR combined verdict + the key risk, and note whether "
        "the two methods agree (consensus = higher conviction). Use the real numbers.\n"
