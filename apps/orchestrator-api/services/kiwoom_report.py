...
def build_kiwoom_report(db, trace_id: str) -> dict:
    ...
    try:
        ...
        sysmsg = (
            ...
            "⚠ DO NOT REPEAT THE TABLE'S NUMBERS. The raw figures (등락률%, 시가/종가/"
            "거래량, 외국인/기관/개인 순매수 수량, 공매도 수치, MA 값) already live in the "
            "Section 2 table — NEVER re-list them in prose. Section 3 is INTERPRETATION, "
            "not a data readout.\n"
