...
CATALYST_SECTION_RULE = (
    ...
    "(a) a '### 다가오는 촉매 일정' section — do NOT use a Markdown table. Write each "
    "event as its own Korean bullet line in this shape: '• <시점> — <촉매/이벤트> · "
    "해당 종목: <…> · 예상 영향: <…> · 선제 포지션: <…>' — listing real scheduled or "
    "expected events (earnings, product launches, GTC/CES, FOMC/CPI/rate decisions, "
    "policy/tariff rulings, executive visits, ADR/US listings, M&A, index rebalances). "
    "Korean dates/timing; mark uncertain ones '예상'.\n"
