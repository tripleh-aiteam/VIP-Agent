    ...
    messages: [
      { id: "m1", at: now() - mins(40), author: "customer", kind: "voice",
        voice: {
          ...
          durationSec: 12,
          transcript: "Hi, this is Park Ji-young. I wanted to ask about this month's rent payment.",
        },
        confidence: 0.94 },
      { id: "m2", at: now() - mins(38), author: "bot", kind: "text",
        text: "Hello Ji-young. What would you like to know about your rent?",
  ...
  // 5. Boss-OUT mode: bot autonomously sent rent reminders to multiple tenants
  {
    ...
    messages: [
      { id: "m1", at: now() - hours(4), author: "bot", kind: "text",
        text: "Hi Young-su, this is Triple-H Real Estate's AI assistant. Your rent payment due date is May 14, in 3 days. Your auto-pay isn't set up, so sending you a reminder.",
      ...
      { id: "m5", at: now() - hours(3) + mins(1), author: "bot", kind: "text",
        text: "Thank you Young-su. Have a great day!",
  ...
  // 6. ESCALATED — urgent, Telegram alert sent to Boss
  {
    ...
    messages: [
      ...
      { id: "m2", at: now() - hours(6) + mins(2), author: "bot", kind: "text",
        text: "Hello Jae-ho. B-201 terms: monthly rent 1.8M KRW, deposit 20M KRW, maintenance fee separate. Let me know if you have other questions.",
        botMeta: { status: "auto" } },
      ...
      { id: "m5", at: now() - mins(42), author: "bot", kind: "text",
        text: "Thank you Jae-ho. The owner will respond directly about the deposit. Please hold on a moment — they'll be in touch shortly.",
    ...
    messages: [
      { id: "m1", at: now() - days(1) - hours(2), author: "customer", kind: "voice",
        voice: { url: "/mock/voice_seo_1.mp3", durationSec: 24,
                 transcript: "Hi, this is Seo Yeon-su. I'd like to ask about renewing my lease next month." },
        confidence: 0.92 },
      { id: "m2", at: now() - days(1) - hours(2) + mins(1), author: "bot", kind: "text",
        text: "Hello Yeon-su. Your current lease expires on June 30. On renewal, there's a planned 5% rent increase. How would you like to proceed — should I send over the detailed terms?",
        botMeta: { status: "auto" } },
      ...
      { id: "m4", at: now() - days(1) - hours(1) - mins(30), author: "boss", kind: "text",
        text: "Hi Yeon-su, this is the owner replying directly. I can adjust to a 3% increase. Does that work for you?" },
